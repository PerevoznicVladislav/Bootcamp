...
# CODUL TĂU VINE MAI JOS:
print("Setul numbers_set este:", numbers_set)
# CODUL TĂU VINE MAI SUS:
...
print("Verificam daca nu primim eroare dupa stergere:", numbers_set)
# CODUL TĂU VINE MAI SUS:

# Verificați dacă numărul 3 există în setul `numbers_set`

# CODUL TĂU VINE MAI JOS:
print("Verificarea elementului 3 in set:", 3 in numbers_set)
# CODUL TĂU VINE MAI SUS:

# Verificați elementele comune din setul `numbers_set` și setul {4, 5, 6, 7}

# CODUL TĂU VINE MAI JOS:
print("Verificarea elementelor comune:", numbers_set.intersection({4, 5, 6, 7}))
# CODUL TĂU VINE MAI SUS:

# Verificați elementele diferite din setul `numbers_set` și setul {4, 5, 6, 7}

# CODUL TĂU VINE MAI JOS:
print("Verificarea diferentei:", numbers_set.difference({4, 5, 6, 7}))
# CODUL TĂU VINE MAI SUS:

# Verificați dacă setul `numbers_set` este un subset al setului {1, 2, 3, 4, 5, 6, 7}

# CODUL TĂU VINE MAI JOS:
print("Verificarea daca este subset pentru variabila:", numbers_set.issubset({1, 2, 3, 4, 5, 6, 7}))
# CODUL TĂU VINE MAI SUS:

# Verificați dacă setul {1, 2, 3, 4, 5, 6, 7} este un subset al setului `numbers_set`

# CODUL TĂU VINE MAI JOS:
print("Verificarea daca este subset pentru setul introdus:", {1, 2, 3, 4, 5, 6, 7}.issubset(numbers_set))
# CODUL TĂU VINE MAI SUS:

# Verificați dacă setul `numbers_set` este un superset al setului {1, 2, 3, 4, 5, 6, 7}

# CODUL TĂU VINE MAI JOS:
print("Verificarea daca este superset pentru variabila:", numbers_set.issuperset({1, 2, 3, 4, 5, 6, 7}))
# CODUL TĂU VINE MAI SUS:

# Verificați dacă setul {1, 2, 3, 4, 5, 6, 7} este un superset al setului `numbers_set`

# CODUL TĂU VINE MAI JOS:
print("Verificarea daca este superset pentru setul introdus:", {1, 2, 3, 4, 5, 6, 7}.issuperset(numbers_set))
# CODUL TĂU VINE MAI SUS:

# Afișați lungimea setului `numbers_set`

# CODUL TĂU VINE MAI JOS:
print("Lungimea variabilei este:", len(numbers_set))
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
print("Setul a fost sters:", numbers_set)
# CODUL TĂU VINE MAI SUS:
