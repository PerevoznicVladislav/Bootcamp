...
# CODUL TĂU VINE MAI JOS:
print("Lista contine urmatoarele numere:" , numbers)
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
print("Adaugam elementul 6 in lista:", numbers)
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
print("Stergem elementul 3 din lista:" , numbers)
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
print("Sortarea crescator a listei:", numbers)
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
print("Adaugarea elementului 3 in pozitia 2:", numbers)
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
print("Lista noua este:", numbers2)
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
print("Lista transformata in string:", str(numbers))
# CODUL TĂU VINE MAI SUS:
