...
if 'phyton' in text:
    ...
    print('Variabila text nu contine cuvantul phyton')
# Sau alta metoda
...
# CODUL TĂU VINE MAI JOS:
f_string = f'Numele primului particiant este {name}, iar numele urmatorului la fel este {name2}!'
print(f_string)
# CODUL TĂU VINE MAI SUS:
...
print(f_string[77]) # Control aditional
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
name3 += text
print('Valoarea pt variabuila name3:',name3) #name = Vlad, name2 = Vlad, text = Salut phyton\n Salut Vlad
# CODUL TĂU VINE MAI SUS:
